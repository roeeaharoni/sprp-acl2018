...
def main():
    ...
    model_files = [base_path+'/git/phrasing/models/sprp_onmt_copy_128/sprp_onmt_copy_128_acc_87.46_ppl_1.74_e13.pt',
                   base_path+'/git/phrasing/models/sprp_onmt_copy_128/sprp_onmt_copy_128_acc_87.46_ppl_1.74_e14.pt',
                   base_path+'/git/phrasing/models/sprp_onmt_copy_128/sprp_onmt_copy_128_acc_87.45_ppl_1.74_e15.pt',
                   base_path+'/git/phrasing/models/sprp_onmt_copy_128/sprp_onmt_copy_128_acc_87.45_ppl_1.74_e16.pt',
                   base_path+'/git/phrasing/models/sprp_onmt_copy_128/sprp_onmt_copy_128_acc_87.45_ppl_1.74_e17.pt']
    ...
    results_file = codecs.open(results_file_path, 'a','utf8')
