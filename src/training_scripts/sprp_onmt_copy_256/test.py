...
def main():
    ...
    test_dirs_path_prefix = base_path + '/git/Split-and-Rephrase/evaluation-directories/test/'

    # the file containing the ids of the test sentences
    test_sent_ids_path = base_path + '/git/Split-and-Rephrase/benchmark/complex-sents/test.id'
